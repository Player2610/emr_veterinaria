...
export declare enum VetSpecialty {
...
export type VetSummary = Pick<Veterinarian, 'id' | 'firstName' | 'lastName' | 'title' | 'specialties' | 'status' | 'photoUrl' | 'calendarColor' | 'acceptingNewPatients' | 'tenantId'>;
//# sourceMappingURL=vet.types.d.ts.map