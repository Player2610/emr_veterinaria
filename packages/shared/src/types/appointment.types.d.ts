...
import { AppointmentStatus, AppointmentType, AppointmentPriority } from '../enums/appointment.enum';
...
export type AppointmentSummary = Pick<Appointment, 'id' | 'petId' | 'ownerId' | 'vetId' | 'type' | 'status' | 'priority' | 'scheduledAt' | 'scheduledEndAt' | 'durationMinutes' | 'reasonForVisit' | 'tenantId'> & {
    petName?: string;
