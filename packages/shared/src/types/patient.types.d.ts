...
export declare enum ReproductiveStatus {
    INTACT = "INTACT",
...
export declare enum PetIdentificationType {
    MICROCHIP = "MICROCHIP",
    TATTOO = "TATTOO",
...
export type PetSummary = Pick<Pet, 'id' | 'name' | 'species' | 'gender' | 'healthStatus' | 'status' | 'ownerId' | 'tenantId' | 'photoUrl'> & {
    breedName?: string;
