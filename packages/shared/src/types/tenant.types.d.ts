...
export type TenantFontFamily = 'Inter' | 'Roboto' | 'Poppins' | 'Nunito' | 'Open Sans' | 'Lato' | string;
/** Variantes de radio de borde para el tema */
export type TenantBorderRadius = 'none' | 'sm' | 'md' | 'lg' | 'xl' | 'full';
...
export type TenantSummary = Pick<Tenant, 'id' | 'name' | 'slug' | 'status' | 'plan' | 'theme'>;
